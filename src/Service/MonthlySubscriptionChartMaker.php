...
class MonthlySubscriptionChartMaker extends ChartMaker
{
    ...
    private function isLastSeasonInFile(array $seasonMonthlyCount, int $seasonIndex, bool $lastIndex): bool
    {
        if (
            !$lastIndex &&
            $seasonMonthlyCount[$seasonIndex]['month'] ===
